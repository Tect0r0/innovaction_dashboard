    ...
    return(
        <div className="page">
            ...
            <form>
                ...
                <input id="correo" type="email" name="correo" placeholder="Correo" required/><br/>
                <label htmlFor="grupo">Grupo estudiantil:</label>
                <input id="grupo" type="text" name="grupo" placeholder="Grupo" required/><br/>
                ...
                <input id="fecha" type="datetime-local" name="fecha" min="2024-01-01T00:00" max="2024-06-30T23:59" step="1"/><br/>
